...
Analyze the functions, interfaces, and interface settings of Servicenow, plan and write down the types, and create a new database: ITSMDB. Develop the initial ITSM_api project. Research ssms to grant api access rights.
```

```
14/4/2025 (Training)

1. Fix the bug of hsaerp app, modify the code of api:5200, and increase the speed of chassis data search. Repair and modify hsaerp app according to the boss's requirements.
2. itsm api register new user successfully
```

```
15/4/2025 (Training)

1. Modify hsahq app and add advanced search options in plan interface
2. Modify hsahq app and modify chassis picture interface to directly display all pictures
3. Develop ITSM Node Api and SSMS ITSM API.
```

```
16/4/2025 (Training)

1. Develop database ITSM API.
2. Develop ITSM node API project
3. Test node API in postman
```

```
17/4/2025 (Training)

1. Fix the problem of hsahq app and modify the movement interface of chassis interface.
2. Open a new project ITSM, configure api, models, and develop home page
```

```
18/4/2025 (Training)

Study how to parse .rpt files with code, how to convert to pdf, save, automatic method, just provide id. Use python to implement this method
```

```
21/4/2025 (Training)

Fixed hsahq's code and input issues, and realized the effect of converting rpt files to pdf and opening them on mobile.
```

```
22/4/2025 (Training)

Study how to open net mvc projects in iis. Design the homepage of ITSM.
```

```
23/4/2025 (Training)

Designed the incident, all and create interfaces of itsm, and designed the homepage of itsm.
```

```
24/4/2025 (Training)

Go to the showroom to learn about the server and complete the three APIs of itx. Design the interface of itsm.
```

```
25/4/2025 (Training)

Add the effects of itsm menu, add other itsm interfaces, and study the drag effect of todo.
```

```
28/4/2025 (Training)

1. Design ITSM website.
2. Configure new computer and install program.
```
